...
bool pathExists(string maze[], int nRows, int nCols, int sr, int sc, int er, int ec)
{
    ...
    {
        Coord location = coordStack.top();
        coordStack.pop(); //Pop top coord off -- location holds current (r,c)
        ...
        {
            coordStack.push(Coord(location.r()-1, location.c())); //Push coordinate (r-1, c)
        ...
        {
            coordStack.push(Coord(location.r(),location.c()+1)); //Push coordinate (r, c+1)
