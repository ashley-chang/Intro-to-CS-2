...
void Game::play()
{
    ...
    {
        m_pit->display(msg); //Prints out pit
        msg = "";
        cout << endl;
        ...
        else
        {
            switch (action[0])
            {
                ...
                case 'r':
                    ...
                    //m_pit->history().record(p->row(), p->col()); //NOTE: ADDED STUFF HERE
                        //Use record function with pointer to pit history object
                    break;
                case 'h':
                    m_pit->history().display(); //If type 'h', print out history of movements
